---
title: "Jason's COVID-19 Dashboard"
output: 
...
##COVID-19  flexdashboard based on my COVID-19 Data Pull, Aggregation, and Plotting Code##
...
=======================================================================
### Home
This dashboard allows you to explore some of the data connected to the ongoing COVID-19 pandemic. There may be some brief load times as the web page file size is fairly large and is being run on a personal server. The graphs are interactive, you can double click a specific state to see only its data. There is a toolbar that will appear when you mouse over the graph that will allow you to auto-scale the graph to get a better idea of what's going on with the data.

I plan on adding more features in the future, such as tabular data and more interactive functions. If you have ideas or are interested in my work, feel free to reach out to me at jasondouglasgibbs@gmail.com. You can also check my GitHub out [here](https://github.com/jasondouglasgibbs).


This dashboard was created using RStudio and the R programming language with various packages. Data used to create these graphs are from [Johns Hopkins CSSE GitHub](https://github.com/CSSEGISandData/COVID-19) for cases/deaths and the [CDC's Vaccine Information Page](https://covid.cdc.gov/covid-data-tracker/#vaccinations).

Below is a table containing a few COVID-19 values for the United States.
```{r table}
kable(Values_Table, format.args=list(big.mark=","), caption = "<center>**Table 1: Summary COVID-19 Values for the United States**<center>") %>% kableExtra::kable_styling(bootstrap_options = c("striped","hover","condensed", "responsive")) 
```
...
### Plot showing the cummulative number of COVID-19 cases by state over time.
...
### Plot showing the cummulative number of COVID-19 deaths by state over time.
...
Vaccines
=======================================================================
### Plot showing percent of a State's population that has received a dose of the COVID-19 Vaccine.

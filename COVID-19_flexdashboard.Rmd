...
This dashboard was created using RStudio and the R programming language with various packages. Data used to create these graphs are from [Johns Hopkins CSSE GitHub](https://github.com/CSSEGISandData/COVID-19) for cases/deaths and [Centers for Civic Impact GitHub](https://github.com/govex/COVID-19/tree/master/data_tables/vaccine_data) for vaccine information.
...
Vaccines
=======================================================================
### Plot showing the percent of total population that has received a dose of COVID-19 vaccine by state.
